...
#SBATCH --mem=50000
#SBATCH --output=./autrain_job_test30.out
...
autrainer train -cn  GG_train-5dB_test30dB.yaml device=cuda
#
autrainer train -cn   GG_train0dB_test30dB.yaml device=cuda
#
autrainer train -cn   GG_train10dB_test30dB.yaml device=cuda
#
autrainer train -cn   GG_train20dB_test30dB.yaml device=cuda
