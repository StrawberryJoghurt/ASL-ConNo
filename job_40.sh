...
#SBATCH --mem=50000
#SBATCH --output=./autrain_job_40.out
...
#autrainer train -cn  AA_train40dB_test0dB.yaml device=cuda
#
#autrainer train -cn   AA_train40dB_test-5dB.yaml device=cuda
#
#autrainer train -cn   AA_train40dB_test10dB.yaml device=cuda
#
#autrainer train -cn   AA_train40dB_test20dB.yaml device=cuda

autrainer train -cn   AA_train40dB_test30dB.yaml device=cuda
